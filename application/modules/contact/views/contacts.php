...
<body>
    <div class="container-sm">
        ...
        <h3><?php echo $current_user['user_first_name'] . ' ' . $current_user['user_last_name'] . "'s "; ?> contacts</h3>
                    ...
                    <?php if (!empty($contacts)) : ?>
                        ...
                        <?php foreach ($contacts as $contacts_item) : ?>
                            <tr>
                                ...
                                <td><?php echo $contacts_item->contact_first_name . ' ' . $contacts_item->contact_last_name; ?></td>
                                            ...
                                            <div class="col">
                                                <div class="modal-body">
                                                    <?php if (!empty($user_options)) : ?>
                                                        <?php echo form_dropdown('user_selected', $user_share_options, 'Default'); ?>
                                                    <?php else : ?>
