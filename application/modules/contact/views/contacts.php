    ...
    <div class="container-sm">
        ...
        <div>
            ...
            <div class="input-group mb-3 mt-3">
                <button class="btn btn-outline-primary dropdown-toggle" id="searchContactFilter" type="button"
                    data-bs-toggle="dropdown" aria-expanded="false">Search by </button>
                    ...
                    <?php if (!empty($contacts)): ?>
                        ...
                        <?php foreach ($contacts as $contacts_item): ?>
                            <tr>
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <div class="btn-group btn-group-sm" role="group"
                                            ...
                                            <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                                data-bs-target="#editContactModal<?php echo $contacts_item->contact_id; ?>">Edit</button>
                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#confirmDeleteModal<?php echo $contacts_item->contact_id; ?>">Delete</button>
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#shareContactModal<?php echo $contacts_item->contact_id; ?>">Share</button>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <div class="modal fade" id="editContactModal<?php echo $contacts_item->contact_id; ?>"
                                    tabindex="-1" aria-labelledby="editContactModal" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="row g-3 mb-3">
                                                    <div class="col">
                                                        <input name="firstname" value=<?php echo $contacts_item->contact_first_name; ?> type="text"
                                                            class="form-control" placeholder="First name"
                                                            aria-label="First name" required />
                                                    </div>
                                                    <div class="col">
                                                        <input name="lastname" value=<?php echo $contacts_item->contact_last_name; ?> type="text"
                                                ...
                                                <div class="row g-3 mb-3">
                                                    <div class="col">
                                                        <input name="email" value=<?php echo $contacts_item->contact_email; ?>
                                                            type="email" class="form-control" placeholder="Email address"
                                                            aria-label="Email address" required />
                                                    </div>
                                                    <div class="col">
                                                        <input name="phone" value=<?php echo $contacts_item->contact_phone; ?>
                                                            type="text" class="form-control" placeholder="Phone number"
                                                            aria-label="Phone number" required />
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <input name="companyname" value=<?php echo $contacts_item->contact_company_name; ?> type="text"
                                                        class="form-control" placeholder="Company name"
                                                        aria-label="Company name" required />
                                                </div>
                                                <div class="col">
                                                    <input type="hidden" name="contact_id" value=<?php echo $contacts_item->contact_id; ?> type="text" class="form-control"
                                                        placeholder="contact_id" aria-label="contact_id" required />
                                                </div>
                                ...
                                <div class="modal fade" id="confirmDeleteModal<?php echo $contacts_item->contact_id; ?>"
                                    tabindex="-1" aria-labelledby="confirmDeleteModal" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                                <input type="hidden" name="contact_id"
                                                    value="<?php echo $contacts_item->contact_id; ?>" />
                                ...
                                <div class="modal fade" id="shareContactModal<?php echo $contacts_item->contact_id; ?>"
                                    tabindex="-1" aria-labelledby="shareContactModal" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="submit" class="btn btn-primary"
                                                        data-bs-dismiss="modal">Share</button>
            ...
            <div class="modal fade" id="addNewContactModal" tabindex="-1" aria-labelledby="addNewContactModal"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col">
                                    <input name="firstname" value="<?php echo set_value('firstname'); ?>" type="text"
                                        class="form-control" placeholder="First name" aria-label="First name"
                                        required />
                                </div>
                                <div class="col">
                                    <input name="lastname" value="<?php echo set_value('lastname'); ?>" type="text"
                                        class="form-control" placeholder="Last name" aria-label="Last name" required />
                                </div>
                            </div>
                            <div class="row g-3 mb-3">
                                <div class="col">
                                    <input name="email" value="<?php echo set_value('email'); ?>" type="email"
                            ...
                            <div class="col">
                                <input name="companyname" value="<?php echo set_value('companyname'); ?>" type="text"
                                    class="form-control" placeholder="Company name" aria-label="Company name"
                                    required />
                            </div>
                            <div class="modal-footer">
